...
class ADODB_gtfw_mysqli extends ADOConnection {
   var $databaseType = 'gtfw_mysqli';
...
class ADORecordSet_gtfw_mysqli extends ADORecordSet{

   var $databaseType = "gtfw_mysqli";
   var $canSeek = true;

   function ADORecordSet_gtfw_mysqli($queryID, $mode = false)
   {
     if ($mode === false)
       {
         global $ADODB_FETCH_MODE;
